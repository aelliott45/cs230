...
class Parser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--max_iters', default=300)
        ...
        # Only parse known args to get --task value
        ...
        if task == 'congestion_gpdl':
            ...
            self.parser.add_argument('--dataroot', default='/home/ec2-user/CircuitNet/IR_drop_training_set/IR_drop')
            ...
            # self.parser.add_argument('--lap_weight', default=1.0, type=float)
            # self.parser.add_argument('--lap_mode', default='match', choices=['match','pred'])
